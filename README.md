...
# phant-output-thermalprinter [![Build Status](https://secure.travis-ci.org/sparkfun/phant-output-thermalprinter.png?branch=master)](http://travis-ci.org/sparkfun/phant-output-thermalprinter)
